...
public class SingleJoin {
    ...
    public ConstraintAutomaton defaultJoin(ConstraintAutomaton automaton_1, ConstraintAutomaton automaton_2) throws JoinOperationFailedException {
        ConstraintAutomaton joinedAutomaton = new ConstraintAutomaton();
        joinedAutomaton.setId(automatonUtils.getJoinedAutomatonId(automaton_1.getId(), automaton_2.getId()));
        List<State> states1 = automaton_1.getStates();
        List<State> states2 = automaton_2.getStates();
    ...
    public ConstraintAutomaton initialJoin(ConstraintAutomaton automaton_1, ConstraintAutomaton automaton_2) throws JoinOperationFailedException {
        ConstraintAutomaton joinedAutomaton = new ConstraintAutomaton();
        joinedAutomaton.setId(automatonUtils.getJoinedAutomatonId(automaton_1.getId(), automaton_2.getId()));
        List<State> states1 = automaton_1.getStates();
        List<State> states2 = automaton_2.getStates();
