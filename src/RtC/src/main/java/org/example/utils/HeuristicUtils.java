...
public class HeuristicUtils {
    ...
    public int getRelationalHeuristicValue(AutomatonHeuristic automaton_1, AutomatonHeuristic automaton_2, int heuristicType) throws WrongHeuristicTypeSelectionException {
        return switch (heuristicType) {
